...
const UserProfile: React.FC = () => {
  ...
  return (
    <div className='container mx-auto px-4 py-12'>
      <h1
        className={`text-3xl font-bold mb-6 text-e-blue transition-opacity duration-700 ease-out ${
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
        ...
        <div
          className={`lg:col-span-2 space-y-6 transition-all duration-700 ease-out transform ${
        ...
        >
          <Tabs defaultValue='bookings'>
            ...
            <TabsContent
              value='bookings'
              className={`mt-0 transition-opacity duration-500 ease-out ${
                isLoaded ? 'opacity-100' : 'opacity-0'
              }`}
            >
              <BookingHistory
            ...
            <TabsContent
              value='favorites'
              className={`mt-0 transition-opacity duration-500 ease-out delay-100 ${
                isLoaded ? 'opacity-100' : 'opacity-0'
              }`}
            >
            ...
            <TabsContent
              value='profile'
              className={`mt-0 transition-opacity duration-500 ease-out delay-200 ${
                isLoaded ? 'opacity-100' : 'opacity-0'
              }`}
            >
              <ProfileSettings
            ...
            <TabsContent
              value='security'
              className={`mt-0 transition-opacity duration-500 ease-out delay-300 ${
                isLoaded ? 'opacity-100' : 'opacity-0'
              }`}
            >
