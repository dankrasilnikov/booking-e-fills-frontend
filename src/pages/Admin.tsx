          ...
          <CardContent>
            <form onSubmit={handleAddStation} className="space-y-4">
              <div className="space-y-2">
                <label htmlFor="title" className="text-sm font-medium">Station Title</label>
                <Input
                  id="title"
                  name="title"
              ...
              <div className="space-y-2">
                <label htmlFor="connectorCount" className="text-sm font-medium">Number of Connectors</label>
                <Input
                  id="connectorCount"
                  name="connectorCount"
                  type="number"
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <label htmlFor="stationId" className="text-sm font-medium">Station Name</label>
                <Input
                  id="stationId"
                  type="text"
              ...
              <Button 
                ...
                disabled={isLoading}
                onClick={() => {
                  const name = (document.getElementById('stationId') as HTMLInputElement).value;
