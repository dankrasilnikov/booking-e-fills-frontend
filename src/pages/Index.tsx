    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-10 md:mb-0">
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 animate-fade-in" style={{ animationDelay: '0.4s' }}>
                <Link to="/map">
                  <Button size="lg" className="w-full sm:w-auto">Find Charging Station</Button>
                </Link>
                <Link to="/register">
            ...
            <div className="md:w-1/2">
              <div className="relative">
                ...
                />
                <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-lg shadow-lg animate-fade-in" style={{ animationDelay: '0.5s' }}>
      ...
      <section className="py-16 bg-white">
        <div className="container px-4 mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">How Zephyra Works</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="feature-card">
              ...
              <p className="text-gray-600">
                Find charging stations near you or along your planned route using our interactive map.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p className="text-gray-600">
                Book charging slots ahead of time to ensure availability when you need it.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <p className="text-gray-600">
                Use our QR code system for easy authentication and seamless charging.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0 md:pr-12">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Our interactive map shows all available charging stations across the country. Filter by charging speed, availability, and connector type.
              </p>
              <Link to="/map">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                <div className="w-10 h-10 rounded-full bg-e-blue flex items-center justify-center text-white mr-3">M</div>
                <div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                <div className="w-10 h-10 rounded-full bg-e-green flex items-center justify-center text-white mr-3">L</div>
                <div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <div className="flex items-center mb-4">
                <div className="w-10 h-10 rounded-full bg-e-blue flex items-center justify-center text-white mr-3">J</div>
                <div>
      ...
      <section className="bg-gradient-to-r from-e-blue to-e-green py-16 text-white">
        <div className="container px-4 mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Simplify Your EV Charging?</h2>
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Join thousands of EV owners across the Netherlands who have made the switch to Zephyra.
          </p>
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <Link to="/map">
              <Button size="lg" variant="outline" className="bg-transparent border-white text-white hover:bg-white hover:text-e-blue w-full sm:w-auto">
