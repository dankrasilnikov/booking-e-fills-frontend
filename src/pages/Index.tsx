...
const FEATURES: Feature[] = [
  {
    icon: <MapPin className='text-e-blue' size={24} />,
    title: 'Locate Stations',
    desc: 'Find charging stations near you or along your planned route using our interactive map.',
    delayClass: 'delay-0',
  },
  {
    icon: <Calendar className='text-e-green' size={24} />,
    title: 'Reserve in Advance',
    desc: 'Book charging slots ahead of time to ensure availability when you need it.',
    delayClass: 'delay-200',
  },
  {
    icon: <QrCode className='text-e-blue' size={24} />,
    title: 'Scan & Charge',
    desc: 'Use our QR code system for easy authentication and seamless charging.',
  ...
  <div className='flex flex-col min-h-screen'>
      ...
      <div className='container px-4 mx-auto'>
        <div className='text-center mb-16'>
          ...
          <p className='text-lg text-gray-600 max-w-2xl mx-auto animate-fade-in delay-200'>
            Our platform makes finding and using EV charging stations simple and
            convenient.
          </p>
        </div>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          {FEATURES.map(({ icon, title, desc, delayClass }) => (
            <div
              key={title}
              className={`bg-gray-50 p-6 rounded-lg text-center animate-fade-in ${delayClass} hover:shadow-xl hover:-translate-y-1 hover:scale-105`}
            >
        ...
        <div className='flex flex-col md:flex-row items-center'>
          <div className='md:w-1/2 mb-8 md:mb-0 md:pr-12 animate-fade-in'>
            ...
            <p className='text-lg text-gray-600 mb-6'>
              ...
              the country. Filter by charging speed, availability, and connector
              type.
            </p>
            <Link to='/map'>
              <Button size='lg' className='w-full sm:w-auto'>
    ...
    <section className='py-16 bg-white overflow-hidden'>
      <div className='container px-4 mx-auto'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          {TESTIMONIALS.map(
            ({ initials, name, role, quote, bgColor, delayClass }) => (
              <div
                key={name}
                className={`bg-gray-50 p-6 rounded-lg animate-fade-in ${delayClass}`}
              >
                <div className='flex items-center mb-4'>
                  <div
                    className={`${bgColor} w-10 h-10 rounded-full flex items-center justify-center text-white mr-3`}
                  >
                    {initials}
                  </div>
                  <div>
    ...
    <section className='bg-gradient-to-r from-e-blue to-e-green py-16 text-white overflow-hidden'>
      <div className='container px-4 mx-auto text-center'>
        ...
        <p className='text-lg mb-8 max-w-2xl mx-auto animate-fade-in delay-200'>
