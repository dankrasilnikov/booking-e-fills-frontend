...
const MapMarkers = ({ stations, userLocation, onStationSelect, isLoading }: MapContainerProps) => {
  return (
    <>
...
export const MapComponent = ({ stations, userLocation, onStationSelect, isLoading }: MapContainerProps) => {
